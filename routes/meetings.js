...
import { isSameDay, validateArrayElements, validateCommentNoteBody, validateIntRange, validateUserId } from "../utils/validation.js";

const router = express.Router();

//todo fix todos in GET /meetings before removing this
let testMatrix = [
